...
public class Calculator extends javax.swing.JFrame {
    ...
    double num, ans,round;
    int input, control, pointer , point;
    public Calculator() {
        initComponents();
        jRadioButton1.setEnabled(false);
    }
    public void arithmatic_calculation()
    {
        switch(input){
             case 1:
                 ans = num + Double.parseDouble(jTextField1.getText());
                 String u = Double.toString(ans);
                 int n = u.length();
                 if (n > 14)
                 {
                    DecimalFormat java = new DecimalFormat ("0.0000000000000");
                    String java1 = java.format(ans);
                    jTextField1.setText(java1);
                 }
                 else
             ...
             case 4:
             ans = num / Double.parseDouble(jTextField1.getText());
                String d = Double.toString(ans);
                 int k = d.length();
                 if (k > 15)
                 {
                    DecimalFormat java = new DecimalFormat ("0.00000000000000");
                    String java1 = java.format(ans);
                    jTextField1.setText(java1);
                 }
                 else
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGap(4, 4, 4))
                            .addComponent(label1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
